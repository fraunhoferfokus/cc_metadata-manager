    ...
    constructor() {
        ...
        this.getMetadataByQueryIDs = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let reuest = (yield axios_1.default.post(`${METADATA_BILO_API}`, product_ids, context.config)).data;
                let i = 0;
                for (let request_product_id_response of reuest) {
                    let product_id = product_ids[i];
                    const request_product_id_response_data = request_product_id_response;
